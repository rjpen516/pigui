...
class Home(Canvas):
    def __setup__(self, screen):
        ...
        self.button.add_button('show_editor',self.make_moving_form_visable,0,self.runner.size[1]-25,75,self.runner.size[1])
        self.button.add_attributes('show_editor','text','Show Move')
        self.button.add_attributes('show_editor','text_size',25)
